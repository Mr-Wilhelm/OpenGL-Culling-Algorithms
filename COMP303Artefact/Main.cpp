...
#pragma region old buffer and texture code
...
#pragma endregion
    ...
    while (!glfwWindowShouldClose(window))  //TODO: update the rendering loop stuff
    {
        ...
        glm::mat4 projection = glm::perspective(glm::radians(camera.Zoom), (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.f, 100.0f);
